...
WapajeSpaceTimeView::WapajeSpaceTimeView (WapajeSpaceTimeFrame *frame, QWidget *parent) : QGraphicsView(parent)
{
  this->frame = frame;
  setScene (&scene);
  selectionRect = NULL;
...
STTypeLayout *WapajeSpaceTimeView::layoutDescriptorForType (PajeType *type)
{
...
STTypeLayout *WapajeSpaceTimeView::createTypeLayout (PajeType *type, STContainerTypeLayout *containerLayout)
{
...
void WapajeSpaceTimeView::renewLayoutDescriptors (void)
{
...
void WapajeSpaceTimeView::hierarchyChanged (void)
{
  //clear the scene
  scene.clear ();
...
void WapajeSpaceTimeView::timeSelectionChanged (void)
{
...
void WapajeSpaceTimeView::wheelEvent (QWheelEvent *event)
{
...
void WapajeSpaceTimeView::mouseMoveEvent (QMouseEvent *event)
{
...
void WapajeSpaceTimeView::mousePressEvent (QMouseEvent *event)
{
  QPointF sp = mapToScene (event->pos());
...
void WapajeSpaceTimeView::mouseReleaseEvent (QMouseEvent *event)
{
  QPointF sp = mapToScene (event->pos());
  double selectionEnd;
