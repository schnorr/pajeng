...
WapajeSpaceTimeFrame::WapajeSpaceTimeFrame (QWidget *parent)
  : QFrame(parent)
{
//  setFrameStyle(Sunken | StyledPanel);
  graphicsView = new WapajeSpaceTimeView (this);
...
WapajeSpaceTimeView *WapajeSpaceTimeFrame::view () const
{
  return graphicsView;
}

void WapajeSpaceTimeFrame::setSpaceTimeLimit (double space, double time)
{
...
void WapajeSpaceTimeFrame::setCurrentTime (double current_time)
{
  QString description;
  if (current_time >= 0){
...
void WapajeSpaceTimeFrame::showEvent ( QShowEvent * event )
{
  setupMatrix();
}

void WapajeSpaceTimeFrame::resizeEvent ( QResizeEvent * event )
{
  setupMatrix();
}

void WapajeSpaceTimeFrame::resetView()
{
  zoomVSlider->setValue(0);
  zoomHSlider->setValue(0);
  setupMatrix();
...
void WapajeSpaceTimeFrame::setResetButtonEnabled()
{
  resetButton->setEnabled(true);
}

void WapajeSpaceTimeFrame::setupMatrix()
{
...
void WapajeSpaceTimeFrame::togglePointerMode()
{
...
void WapajeSpaceTimeFrame::toggleOpenGL()
{
#ifndef QT_NO_OPENGL
...
void WapajeSpaceTimeFrame::toggleAntialiasing()
{
  graphicsView->setRenderHint(QPainter::Antialiasing, antialiasButton->isChecked());
}

void WapajeSpaceTimeFrame::zoomIn(int level)
{
...
void WapajeSpaceTimeFrame::zoomOut(int level)
{
  zoomVSlider->setValue(zoomVSlider->value() - level);
  zoomHSlider->setValue(zoomHSlider->value() - level);
}

void WapajeSpaceTimeFrame::zoomXIn (int level)
{
...
void WapajeSpaceTimeFrame::zoomXOut (int level)
{
  int new_hlevel = zoomHSlider->value() - level;
  if (new_hlevel > zoomHSlider->maximum()){
    zoomHSlider->setMaximum (new_hlevel);
