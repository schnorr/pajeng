...
class WapajeTreemapValueItem : public QGraphicsItem
{
  bool hover;
  WapajeTreemap *treemap;
  WapajeTreemapView *filter;

public:
  WapajeTreemapValueItem (WapajeTreemap *treemap, QGraphicsItem *parent, WapajeTreemapView *filter);
