...
{\Large Version {\bf 1.2.5} - February 14th, 2013} \\
\rule{\linewidth}{2pt}
\end{onehalfspace}
...
Lucas M. Schnorr (UFRGS) -- schnorr@inf.ufrgs.br
...
previously defined container type of \Type, with the color \Color.
...
\Type          & string or integer & Parent container type\\
\Color         & color             & The color of the new variable\\\hline
...
value is defined in the \Color field.
...
\Name                & string or integer & Name of the new value \\
\Color               & color             & Color of the value \\\hline
...
\begin{multicols}{2}
\begin{lstlisting}[basicstyle=\footnotesize,label=header2]
